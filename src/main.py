...
from pandera import errors as pa_errors # Import errors submodule
...
from src.schemas import validate_sample1_data # Import the validation function
...
def sample1(params: Sample1Params) -> None:
    ...
    try:
        ...
        logger.info(f"入力CSVファイル: {csv_path}") # process_id will be automatically included by structlog
        ...
        try:
            ...
            avg_score = df["score"].mean() # Assuming 'score' column exists based on StudentDataSchema
        ...
        logger.info("sample1処理が正常に完了しました") # process_id will be automatically included
        ...
        raise BatchProcessingError(
            ...
            code="E999",
            details={"original_error": str(e), "process_id": params.process_id} # Add process_id to details
        ) from e
    finally:
